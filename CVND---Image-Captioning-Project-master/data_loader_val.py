...
def get_loader_val(transform,
    ...
    Args:
      ...
      vocab_threshold: Minimum word count before adding to vocabulary.
    ...
    if mode == 'val':
        if vocab_from_file==True: 
            assert os.path.exists(vocab_file), "vocab_file does not exist.  Change vocab_from_file to False to create vocab_file."
        img_folder = os.path.join(cocoapi_loc, 'cocoapi/images/train2014/')    # cocoapi_loc='/opt'. val imgs got from train folder 
